...
class MoveableLinePolygon extends StatefulWidget {
  @override
  _MoveableLinePolygonState createState() => _MoveableLinePolygonState();
}

class _MoveableLinePolygonState extends State<MoveableLinePolygon> {
